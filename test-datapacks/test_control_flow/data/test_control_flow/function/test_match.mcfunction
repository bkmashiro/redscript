...
execute if score $_49 rs matches ..0 if score $score rs matches 0 run function test_control_flow:test_match/match_4
execute if score $_49 rs matches ..0 if score $score rs matches 0 run function test_control_flow:test_match/match_5
execute if score $_49 rs matches ..0 if score $score rs matches 0 run function test_control_flow:test_match/match_6
execute if score $_49 rs matches ..0 if score $score rs matches 0 run function test_control_flow:test_match/match_7
execute if score $_49 rs matches ..0 if score $score rs matches 0 run function test_control_flow:test_match/match_8
