...
- [ ] B7. Minimize and fix/diagnose the remaining unresolved dynamic identifiers (`winner`, `tagName`, `item`) and keep `showcase_game.mcrs` covered by compile-all after the `lane` fix.
