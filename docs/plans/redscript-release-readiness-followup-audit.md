...
- Local real harness evidence includes `MC_CORE_REQUIRE_ONLINE=true npm run test:mc-core:live` passing `23/23` descriptor-driven cases on 2026-06-30, including first P1 world/inventory/random smokes (runtime proof for local run only).
