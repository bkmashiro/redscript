...
**Active plan:** [16 — Post-VIR Optimizer Spark Roadmap](./16-post-vir-optimizer-spark-roadmap.md)
...
Use [21](./21-post-vir-decision-adr.md) as the decision source for future `/goal` or Spark continuation prompts.
This roadmap is closed after Tranche F; reopen only if the user starts a new LIR-only tranche.
