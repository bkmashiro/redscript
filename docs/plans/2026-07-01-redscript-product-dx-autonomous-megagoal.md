...
- [ ] E1. Declaration-mode parse/typecheck for `.d.mcrs`.
- [ ] E2. Import/preprocess or compile-stage handling for declaration-only dependencies.
- [ ] E3. Non-emitting compile tests and stage snapshots if useful.
...
- [ ] G1. RED parser/typechecker tests for valid and invalid contexts.
- [ ] G2. Parser/typechecker implementation.
...
- [ ] I1. Audit README/docs claims for static vs live proof language.
- [ ] I2. Ensure README quick-start source compiles if touched.
- [ ] I3. Keep `report:release-evidence` output aligned with new declaration/resource proof labels if they become release-relevant.
