...
export const STDLIB_GAP_CASES: McCoreCaseDescriptor[] = [
  ...
  {
    ...base('calculus', 'gap_calculus'),
    featureIds: [
      'stdlib.calculus.function.deriv_central',
      'stdlib.calculus.function.deriv_forward',
      'stdlib.calculus.function.integrate_simpson',
      'stdlib.calculus.function.integrate_trapezoid',
      'stdlib.calculus.function.running_m2',
      'stdlib.calculus.function.running_mean',
      'stdlib.calculus.function.variance_from_m2',
    ],
    librarySourcePaths: [stdlib('math'), stdlib('calculus')],
    scoreboardAssertions: [
      { player: '#deriv_forward', obj: 'gap_result', value: 10000 },
      { player: '#deriv_central', obj: 'gap_result', value: 10000 },
      { player: '#deriv_central_linear', obj: 'gap_result', value: 20000 },
      { player: '#integrate_trapezoid', obj: 'gap_result', value: 10000 },
      { player: '#integrate_trapezoid_constant', obj: 'gap_result', value: 20000 },
      { player: '#integrate_simpson', obj: 'gap_result', value: 10000 },
      { player: '#running_mean_first', obj: 'gap_result', value: 20000 },
      { player: '#running_mean_second', obj: 'gap_result', value: 30000 },
      { player: '#running_m2', obj: 'gap_result', value: 20000 },
      { player: '#variance_from_m2', obj: 'gap_result', value: 20000 },
    ],
  },
  {
    ...base('expr', 'gap_expr'),
