...
export const STDLIB_GAP_CASES: McCoreCaseDescriptor[] = [
  ...
  },
  {
    ...base('heap', 'gap_heap'),
    featureIds: [
      'stdlib.heap.function.heap_new',
      'stdlib.heap.function.heap_peek',
      'stdlib.heap.function.heap_pop',
      'stdlib.heap.function.heap_push',
      'stdlib.heap.function.heap_size',
      'stdlib.heap.function.max_heap_pop',
      'stdlib.heap.function.max_heap_push',
    ],
    librarySourcePaths: [stdlib('heap')],
    scoreboardAssertions: Object.entries({
      min_empty_size: 0,
      min_size4: 4,
      min_peek0: -2,
  ...
  {
    ...base('math-trig-load', 'gap_math_trig'),
    featureIds: ['stdlib.math.function.cos_fixed', 'stdlib.math.function.sin_fixed'],
    librarySourcePaths: [stdlib('math')],
    scoreboardAssertions: Object.entries({
      sin0: 0, sin30: 500, sin90: 1000, sin150: 500, sin210: -500,
      sin270: -1000, sin330: -500, sin_neg30: -500, sin390: 500,
      cos0: 1000, cos60: 500, cos90: 0, cos180: -1000, cos270: 0, cos_neg60: 500,
    }).map(([player, value]) => ({ player: `#${player}`, obj: 'gap_result', value })),
  },
  {
    ...base('math', 'gap_math'),
